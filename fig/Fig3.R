...
pdf("/home/yincheng23/ADlasso_manuscript/Figure/Figure3.pdf", width=10, height=8)
p
dev.off()

tiff("/home/yincheng23/ADlasso_manuscript/Figure/Figure3.tiff", units="in", width=10, height=8, res=300)
p
dev.off()
